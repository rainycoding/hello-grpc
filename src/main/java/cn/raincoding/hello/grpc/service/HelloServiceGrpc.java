...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "cn.raincoding.hello.grpc.service.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<cn.raincoding.hello.grpc.service.HelloRequest,
      cn.raincoding.hello.grpc.service.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = cn.raincoding.hello.grpc.service.HelloRequest.class,
      responseType = cn.raincoding.hello.grpc.service.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<cn.raincoding.hello.grpc.service.HelloRequest,
      cn.raincoding.hello.grpc.service.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<cn.raincoding.hello.grpc.service.HelloRequest, cn.raincoding.hello.grpc.service.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<cn.raincoding.hello.grpc.service.HelloRequest, cn.raincoding.hello.grpc.service.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cn.raincoding.hello.grpc.service.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cn.raincoding.hello.grpc.service.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(cn.raincoding.hello.grpc.service.HelloRequest request,
        io.grpc.stub.StreamObserver<cn.raincoding.hello.grpc.service.HelloResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                cn.raincoding.hello.grpc.service.HelloRequest,
                cn.raincoding.hello.grpc.service.HelloResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public cn.raincoding.hello.grpc.service.HelloResponse hello(cn.raincoding.hello.grpc.service.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<cn.raincoding.hello.grpc.service.HelloResponse> hello(
        cn.raincoding.hello.grpc.service.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((cn.raincoding.hello.grpc.service.HelloRequest) request,
              (io.grpc.stub.StreamObserver<cn.raincoding.hello.grpc.service.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cn.raincoding.hello.grpc.service.HelloServiceOuterClass.getDescriptor();
    }
